...
def generate_launch_description():
    ...
    config_file = os.path.join(
        ...
        'config', 'transforms', 'static_transforms.yaml'
    )
    ...
    for wheel_name, wheel_data in transforms['wheels'].items():
        ...
        nodes.append(Node(
            ...
            arguments=[
                ...
                str(rot[0]), str(rot[1]), str(rot[2]), str(rot[3]),  # qx, qy, qz, qw
                wheel_data['parent'], wheel_data['child']
            ],
            output='screen'
        ))
    ...
    nodes.append(Node(
        ...
        arguments=[
            ...
            rig_data['parent'], rig_data['child']
        ],
        output='screen'
    ))
    ...
    for sensor_name, sensor_data in transforms['sensors'].items():
        ...
        nodes.append(Node(
            ...
            arguments=[
                str(trans[0]), str(trans[1]), str(trans[2]),
                str(rot[0]), str(rot[1]), str(rot[2]), str(rot[3]),
                sensor_data['parent'], sensor_data['child']
            ],
            output='screen'
        ))
